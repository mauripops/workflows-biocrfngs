...
rule download_files_local:
    ...
    shell:
        """
        cp -v /data3/ztron/autorunDW/DNBSEQ-T7/R*/*/ztron/{wildcards.sequencing_run}_{wildcards.lane}_[0-9][0-9][0-9][0-9][0-9]/{wildcards.sequencing_run}_{wildcards.lane}/`basename {output[0]}` {output[0]}
        cp -v /data3/ztron/autorunDW/DNBSEQ-T7/R*/*/ztron/{wildcards.sequencing_run}_{wildcards.lane}_[0-9][0-9][0-9][0-9][0-9]/{wildcards.sequencing_run}_{wildcards.lane}/`basename {output[1]}` {output[1]}
        """
